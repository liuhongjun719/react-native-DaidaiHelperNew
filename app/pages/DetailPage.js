...
import {DetailPageAction} from '../actions/DetailPageAction.js';
...
import CollectInformationPage from './CollectInformationPage';
...
class DetailPage extends Component {
    ...
    componentDidMount() {
        InteractionManager.runAfterInteractions(() => {
          ...
          dispatch(DetailPageAction(isNoData,isLoadMore, isRefreshing, isLoading, page));
        })
    }
    ...
    render() {
        ...
        let classList = DetailPage.ClassDate;
            ...
            <View>
                ...
                {DetailPage.isLoading ? <Loading /> :
                    <ListView
                      ...
                      refreshControl={
                        <RefreshControl
                          refreshing={DetailPage.isRefreshing}
    ...
    _onPressFeedItem(rowDate) {
        InteractionManager.runAfterInteractions(() => {
            this.props.navigator.push({
                name: 'CollectCollectInformationPage',
                component: CollectInformationPage,
                passProps: {
                    rowDate: rowDate,
                }
            })
    ...
    _renderFooter() {
      const {DetailPage} = this.props;
      return <LoadMoreFooter title = {(DetailPage.isNoData) ? '没有更多数据了' : '正在加载更多……'}
                type = {(DetailPage.isNoData) ? 'NoData' : 'HasData'}/>
    }
